    ...
    <div class="dps-page px-5 py-8">
        <div class="max-w-5xl mx-auto">
            <div class="dps-card rounded-[2rem] p-7 md:p-9">
                <div class="mb-8">
                    <h1 class="text-4xl font-black text-white">Add Health Record</h1>
                    <p class="mt-3 text-slate-300">
                        Track BMI, BP, sugar level, oxygen, sleep, hydration and health notes.
                    </p>
                </div>

                <form method="POST" action="{{ route('user.health-records.store') }}" class="space-y-6">
                    @csrf

                    @include('user.health-records._form')

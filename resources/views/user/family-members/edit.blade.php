    ...
    <div class="dps-page px-5 py-8">
        <div class="max-w-5xl mx-auto">
            <div class="dps-card rounded-[2rem] p-7 md:p-9">
                <div class="mb-8">
                    <h1 class="text-4xl font-black text-white">Edit Family Member</h1>
                    <p class="mt-3 text-slate-300">
                        Update health profile details for better AI analysis.
                    </p>
                </div>

                <form method="POST" action="{{ route('user.family-members.update', $familyMember) }}" class="space-y-6">
                    @csrf
                    @method('PUT')

                    @include('user.family-members._form', ['familyMember' => $familyMember])
